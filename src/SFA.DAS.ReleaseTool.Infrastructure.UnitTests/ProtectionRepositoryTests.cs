...
using SFA.DAS.ReleaseTool.Core.IRepositories;
using SFA.DAS.ReleaseTool.Infrastructure.Repositories;
using Microsoft.AspNetCore.DataProtection;
using System.Threading.Tasks;

namespace SFA.DAS.ReleaseTool.Infrastructure.UnitTests
{
    [TestFixture]
